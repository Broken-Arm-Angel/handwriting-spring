...
import com.dpeng.springframework.context.ConfigurableApplicationContext;
...
import com.dpeng.springframework.context.event.ApplicationEventMulticaster;
import com.dpeng.springframework.context.event.ContextClosedEvent;
import com.dpeng.springframework.context.event.ContextRefreshedEvent;
import com.dpeng.springframework.context.event.SimpleApplicationEventMulticaster;
...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    public void refresh() throws BeansException {
        ...
        // 5. BeanPostProcessor 需要提前与其他 Bean 对象实例化之前进行注册操作
