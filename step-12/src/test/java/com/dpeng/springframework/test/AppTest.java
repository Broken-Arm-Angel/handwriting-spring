...
import com.dpeng.springframework.aop.ClassFilter;
...
import com.dpeng.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import com.dpeng.springframework.test.bean.UserServiceBeforeAdvice;
...
public class AppTest {
    ...
    public void testProxyFactory() {
        advisedSupport.setProxyTargetClass(false); // false/true，JDK 动态代理/Cglib 动态代理
    ...
    public void testAdvisor() {
        ...
        advisor.setExpression("execution(* com.dpeng.springframework.test.bean.IUserService.*(..))");
